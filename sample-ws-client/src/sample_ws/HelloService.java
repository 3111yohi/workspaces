 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://sample_ws/", wsdlLocation = "http://localhost:8080/sample-ws/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://sample_ws/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/sample-ws/HelloService?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://sample_ws/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sample_ws/", "HelloPort"), Hello.class, features);
    }
